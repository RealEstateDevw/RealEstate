"""Утилиты для учёта посещаемости сотрудников.

Все функции работают поверх ORM-модели Attendance и используют контекстную
сессию через dependency `get_db`. Предоставляются операции проверки факта
входа за день и регистрации входа/выхода.
"""
